...
export function ProjectCard({ project }: { project: Project }) {
  ...
  return (
    <Card className="group/card relative h-full gap-0 p-0 ring-foreground/10 transition-all duration-300 hover:-translate-y-1 hover:ring-foreground/20 hover:shadow-lg">
      <Link
      ...
      >
        ...
        <CardHeader className="gap-2 p-5 pb-0">
          ...
          <CardTitle className="flex items-start justify-between gap-3 text-lg">
            ...
            <ArrowUpRight className="mt-0.5 size-4 shrink-0 text-muted-foreground transition-all duration-300 group-hover/card:translate-x-0.5 group-hover/card:-translate-y-0.5 group-hover/card:text-foreground" />
          </CardTitle>
        </CardHeader>
